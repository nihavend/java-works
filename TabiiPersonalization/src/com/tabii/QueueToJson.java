...
import com.tabii.simulation.api.RedisService;
...
public class QueueToJson {
	...
	public static ObjectNode parseQueueJson(Jedis jedis, ObjectMapper mapper, String queueJson) throws JsonMappingException, JsonProcessingException {
	...
	public static ObjectNode parseQueueJson1(RedisService redisService, ObjectMapper mapper, String queueJson) throws JsonMappingException, JsonProcessingException {
	...
	public static ObjectNode parseQueueJson(RedisService redisService, ObjectMapper mapper, String queueJson)
	    ...
	    for (JsonNode rowIdNode : rowIds) {
	        ...
	        if (showsArray == null || showsArray.isEmpty()) continue;
	        ...
	        for (JsonNode showIdNode : showsArray) {
	            ...
	            if (imageIds != null && !imageIds.isEmpty()) {
	                ...
	                for (JsonNode idNode : imageIds) imageKeys.add("image:" + idNode.asText());

	                Map<String, String> imageMap = redisService.mget(imageKeys);
	                for (String json : imageMap.values()) {
	                    if (json != null) imageDataArray.add(mapper.readTree(json));
	                }
	            }
	            ...
	            if (badgeIds != null && !badgeIds.isEmpty()) {
	                ...
	                for (String badgeJson : badgeMap.values()) {
	                    ...
	                    if (badgeImageIds != null && !badgeImageIds.isEmpty()) {
	                        ...
	                        for (JsonNode idNode : badgeImageIds) badgeImageKeys.add("image:" + idNode.asText());
	                        Map<String, String> badgeImageMap = redisService.mget(badgeImageKeys);
	                        for (String imgJson : badgeImageMap.values()) {
	                            if (imgJson != null) badgeImagesData.add(mapper.readTree(imgJson));
	                        }
	                    }
	            ...
	            if (genreIds != null && !genreIds.isEmpty()) {
	                ...
	                for (JsonNode idNode : genreIds) genreKeys.add("genre:" + idNode.asText());
	                ...
	                for (String genreJson : genreMap.values()) {
	                    ...
	                    if (genreImageIds != null && !genreImageIds.isEmpty()) {
	                        ...
	                        for (JsonNode idNode : genreImageIds) genreImageKeys.add("image:" + idNode.asText());
	                        Map<String, String> genreImageMap = redisService.mget(genreImageKeys);
	                        for (String imgJson : genreImageMap.values()) {
	                            if (imgJson != null) genreImagesData.add(mapper.readTree(imgJson));
	                        }
	                    }
